                ...
                <div className="relevance-card-box">
                    <div className="relevance-card-back">
                        <div className="relevance-card-body">
                            {props.rank == 1 ? <img className="medal" src={GoldMedal} alt="Medalha de Ouro" /> : (props.rank == 2 ? <img src={SilverMedal} alt="Medalha de Prata" /> : <img src={BronzeMedal} alt="Medalha de Bronze" />)}
