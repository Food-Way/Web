  ...
  return (
    <div className="comment_insert">
      <span className="comment-section">
        <img className="profile_icon" src={profilePhoto != null ? "https://foodway-public-s3.s3.amazonaws.com/website-images/default-user-image.png" : profilePhoto} alt="Foto de perfil" />
